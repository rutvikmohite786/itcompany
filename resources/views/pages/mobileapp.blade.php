...
<div class="container">
    <div class="d-flex">
        <i class="{{$development->icon}}"></i>
        <div class="d-flex flex-column">
            <h4 class="font-weight-bold mb-3">{{$development->title}}</h4>
            <p>Et kasd justo clita amet kasd, vero amet vero eos kasd diam justo, ipsum diam sed elitr erat</p>
        </div>
    </div>
    <div class="container">
        <div class="container">
            @foreach($development->subservice as $subserv)
            <div class="d-flex">
                <i class="{{$subserv->icon}}"></i> &nbsp;&nbsp;&nbsp;&nbsp;
                <div class="d-flex flex-column">
                    <h4 class="font-weight-bold mb-3">{{$development->name}}</h4>
                    <p>Et kasd justo clita amet kasd, vero amet vero eos kasd diam justo, ipsum diam sed elitr erat</p>
                </div>
            </div>
            @endforeach
